...
public class Lc0466Solution {
    ...
    public static void main(String[] args) {
        Lc0466Solution solution = new Lc0466Solution();

        String s1 = "acb";
        int n1 = 4;
        String s2 = "ab";
        int n2 = 2;
        assert solution.getMaxRepetitions(s1, n1, s2, n2) == 2;

        s1 = "acb";
        n1 = 1;
        s2 = "acb";
        n2 = 1;
        assert solution.getMaxRepetitions(s1, n1, s2, n2) == 1;
    }
}
